...
def _compute_statistics_from_array(imgs, model, batch_size, dims, cuda):
    m, s = calculate_activation_statistics(imgs, model, batch_size,
                                               dims, cuda)
...
def calculate_fig_given_arrays(X, Y, batch_size, cuda, dims):
    ...
    m1, s1 = _compute_statistics_from_array(X, model, batch_size,
                                            dims, cuda)
    m2, s2 = _compute_statistics_from_array(Y, model, batch_size,
                                            dims, cuda)
